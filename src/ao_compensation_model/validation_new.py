...
from utils import RealTimeBandpassFilter
...
model_path= os.path.join(script_dir, 'model', '2026_03_20_14_31_0.2584', 'gru_model_edge.tflite')
scaler_path = os.path.join(script_dir, 'model', '2026_03_20_14_31_0.2584','scaler.pkl')

_stream_state = {
    "model": None,
    "scaler": joblib.load(scaler_path),
    "filter": RealTimeBandpassFilter(lowcut=0.5, highcut=3.0, fs=fs, order=4),
